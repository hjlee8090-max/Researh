# 2026-08-19 — 주간 자기감사 (self-audit, 기계 생성)
...
|---|---|
| A. 원장 정합성 | ✅ 일치 |
| B. 계좌 성과 | 왕복 15건 · 승률 33.3% · PF 0.48 · 순실현 -297,905원 |
| C. vs KOSPI (2026-05-20~) | 계좌 -5.491% vs KOSPI -4.7% → **격차 -0.79%p** |
...
| G. 배치 | 주식 51.4% (tier bull, 목표 [65, 80]) · heat 잔여 211327원 |
...
| `deployment-below-band` | 주식비중 51.4% < 목표 하한 65% — 만성 미배치 | 7주째 🔴overdue | **무처분** (패치 처분 후에도 재발 — 보완 효과 없음, 재상정) |
...
| `lessons-balance` | lessons.md 348,644B > 예산 60,000B — 이관 처리량 부족 | 1주째 | **무처분** |
