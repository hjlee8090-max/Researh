# 2026-09-20 — 주간 자기감사 (self-audit, 기계 생성)
...
| C. vs KOSPI (2026-05-20~) | 계좌 -8.639% vs KOSPI -4.37% → **격차 -4.27%p** |
...
| G. 배치 | 주식 48.2% (tier bull, 목표 [65, 80]) · heat 잔여 259637원 |
...
| `deployment-below-band` | 주식비중 48.2% < 목표 하한 65% — 만성 미배치 | 11주째 | observe — 재확인(09-20) — 주식비중 48.3%(09-13 37.3% 대비 회복, 여전히 목표 하한 65% 미달) |
| `lessons-balance` | lessons.md 720,412B > 예산 60,000B — 이관 처리량 부족 | 6주째 🔴overdue | **무처분** (패치 처분 후에도 재발 — 보완 효과 없음, 재상정) |
