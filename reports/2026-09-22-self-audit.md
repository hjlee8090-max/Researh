...
| C. vs KOSPI (2026-05-20~) | 계좌 -7.737% vs KOSPI -0.73% → **격차 -7.01%p** |
...
| G. 배치 | 주식 43.9% (tier strong_bull, 목표 [80, 95]) · heat 잔여 298645원 |
...
| `deployment-below-band` | 주식비중 43.9% < 목표 하한 80% — 만성 미배치 | 12주째 | observe — 재확인(09-20) — 주식비중 48.3%(09-13 37.3% 대비 회복, 여전히 목표 하한 65% 미달) |
| `benchmark-gap-widening` | vs KOSPI 격차 악화 -4.64%p → -7.01%p | 1주째 | **무처분** |
