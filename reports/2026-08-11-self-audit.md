# 2026-08-11 — 주간 자기감사 (self-audit, 기계 생성)
...
| C. vs KOSPI (2026-05-20~) | 계좌 -4.791% vs KOSPI -11.36% → **격차 6.57%p** |
| D. 스톱 휩쏘 | 손실 스톱 7건 중 t+5 채점 7건 · 휩쏘 5건 (71.4%) · 일실 합계 +222,731원 |
| E. 게이트 위반 | 총 0건 (provenance 0 · timing 0 · chase 0 · shock 0 · card 0) |
| F. 패치 vs 검증 | policy v2.31 (직전 감사 v2.28) · 신규 왕복 0건 |
| G. 배치 | 주식 56.5% (tier bull, 목표 [65, 80]) · heat 잔여 140677원 |
...
| `deployment-below-band` | 주식비중 56.5% < 목표 하한 65% — 만성 미배치 | 6주째 🔴overdue | **무처분** (패치 처분 후에도 재발 — 보완 효과 없음, 재상정) |
| `benchmark-gap-widening` | vs KOSPI 격차 악화 9.63%p → 6.57%p | 1주째 | **무처분** |
| `patch-without-validation` | 검증 표본 없는 정책 패치 — 패치 동결 규칙 발동 | 1주째 | observe — 패치 동결 규칙(감사 처방⑤) 발동 확인 — 직전 감사 대비 policy v2.27→v2.28 버전 증가 + |
