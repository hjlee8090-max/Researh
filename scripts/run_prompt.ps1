...
param(
    ...
    [ValidateSet("0000_global", "0630_us_close", "0900_pre_market", "1200_midday", "1500_close", "1800_report", "saturday_review", "sunday_strategy", "sunday_policy_review", "sunday_archive", "weekend_report")]
    [string]$PromptName
)
