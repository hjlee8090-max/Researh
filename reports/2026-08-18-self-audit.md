# 2026-08-18 — 주간 자기감사 (self-audit, 기계 생성)
...
| C. vs KOSPI (2026-05-20~) | 계좌 -4.709% vs KOSPI -3.2% → **격차 -1.51%p** |
...
| G. 배치 | 주식 51.8% (tier bull, 목표 [65, 80]) · heat 잔여 163690원 |
...
| `deployment-below-band` | 주식비중 51.8% < 목표 하한 65% — 만성 미배치 | 7주째 🔴overdue | **무처분** (패치 처분 후에도 재발 — 보완 효과 없음, 재상정) |
...
| `lessons-balance` | lessons.md 332,651B > 예산 60,000B — 이관 처리량 부족 | 1주째 | **무처분** |
