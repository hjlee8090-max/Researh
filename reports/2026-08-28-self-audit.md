...
| C. vs KOSPI (2026-05-20~) | 계좌 -6.412% vs KOSPI -4.11% → **격차 -2.3%p** |
...
| G. 배치 | 주식 57.0% (tier bull, 목표 [65, 80]) · heat 잔여 159593원 |
...
| `deployment-below-band` | 주식비중 57.0% < 목표 하한 65% — 만성 미배치 | 8주째 | observe — 진단 재점검(08-23) — 병목이 이전 두 라운드(히트예산 소진 8/3, universe theme 결측  |
