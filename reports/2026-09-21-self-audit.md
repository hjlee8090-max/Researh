# 2026-09-21 — 주간 자기감사 (self-audit, 기계 생성)
...
| C. vs KOSPI (2026-05-20~) | 계좌 -8.109% vs KOSPI -4.37% → **격차 -3.74%p** |
...
| G. 배치 | 주식 43.6% (tier strong_bull, 목표 [80, 95]) · heat 잔여 315571원 |
...
| id | 항목 | 경과 | 처분 상태 |
|---|---|---|---|
| `whipsaw-high` | 스톱 휩쏘율 77.8% — 노이즈 저점 매도 반복 | 11주째 | defer — 재확인(09-20) — score_ratchet_shadow.py 재실행 결과 09-13과 수치 불변(bre |
| `deployment-below-band` | 주식비중 43.6% < 목표 하한 80% — 만성 미배치 | 11주째 | observe — 재확인(09-20) — 주식비중 48.3%(09-13 37.3% 대비 회복, 여전히 목표 하한 65% 미달) |
| `lessons-balance` | lessons.md 721,389B > 예산 60,000B — 이관 처리량 부족 | 6주째 🔴overdue | **무처분** (패치 처분 후에도 재발 — 보완 효과 없음, 재상정) |
