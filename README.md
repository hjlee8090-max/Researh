...
| 06:30 | **미등록 — claude.ai/code/routines 에 매일 월~금 06:30 KST 신규 등록 필요** (`prompts/0630_us_close.md`). 미국장 마감 확정·개장 전 갱신. 월요일·미 공휴일 다음날은 프롬프트 §0-0 주말 마감 모드로 자동 분기. 등록 후 발급 `trig_…` ID 를 여기 기입. |
