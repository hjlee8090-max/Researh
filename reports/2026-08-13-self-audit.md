# 2026-08-13 — 주간 자기감사 (self-audit, 기계 생성)
...
| C. vs KOSPI (2026-05-20~) | 계좌 -3.665% vs KOSPI -5.1% → **격차 1.43%p** |
...
| G. 배치 | 주식 57.0% (tier bull, 목표 [65, 80]) · heat 잔여 105232원 |
...
| `benchmark-gap-widening` | vs KOSPI 격차 악화 6.07%p → 1.43%p | 1주째 | **무처분** |
