# 2026-07-20 — 주간 자기감사 (self-audit, 기계 생성)
...
| C. vs KOSPI (2026-05-20~) | 계좌 -5.705% vs KOSPI -7.27% → **격차 1.56%p** |
| D. 스톱 휩쏘 | 손실 스톱 7건 중 t+5 채점 7건 · 휩쏘 5건 (71.4%) · 일실 합계 +222,731원 |
| E. 게이트 위반 | 총 0건 (provenance 0 · timing 0 · chase 0 · shock 0 · card 0) |
| F. 패치 vs 검증 | policy v2.23 (직전 감사 v2.22) · 신규 왕복 0건 |
| G. 배치 | 주식 35.0% (tier bull, 목표 [65, 80]) · heat 잔여 22271원 |
...
| id | 항목 | 경과 | 처분 상태 |
|---|---|---|---|
| `whipsaw-high` | 스톱 휩쏘율 71.4% — 노이즈 저점 매도 반복 | 2주째 | observe — 이미 배치된 대응(v2.20 breakeven_ratchet shadow·v2.22 index_shock_s |
| `deployment-below-band` | 주식비중 35.0% < 목표 하한 65% — 만성 미배치 | 2주째 | observe — 히트예산 소진(잔여 4,234원/예산 363,020원)이 만성 미배치의 직접 병목 — 2026-07-04 s |
