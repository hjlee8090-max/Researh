# 2026-08-09 — 주간 자기감사 (self-audit, 기계 생성)
...
| C. vs KOSPI (2026-05-20~) | 계좌 -4.562% vs KOSPI -14.19% → **격차 9.63%p** |
| D. 스톱 휩쏘 | 손실 스톱 7건 중 t+5 채점 7건 · 휩쏘 5건 (71.4%) · 일실 합계 +222,731원 |
| E. 게이트 위반 | 총 0건 (provenance 0 · timing 0 · chase 0 · shock 0 · card 0) |
| F. 패치 vs 검증 | policy v2.28 (직전 감사 v2.27) · 신규 왕복 0건 |
| G. 배치 | 주식 37.9% (tier bull, 목표 [65, 80]) · heat 잔여 182939원 |
...
| `deployment-below-band` | 주식비중 37.9% < 목표 하한 65% — 만성 미배치 | 5주째 🔴overdue | **무처분** (패치 처분 후에도 재발 — 보완 효과 없음, 재상정) |
