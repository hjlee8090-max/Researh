# 2026-08-02 — 주간 자기감사 (self-audit, 기계 생성)
...
| C. vs KOSPI (2026-05-20~) | 계좌 -7.617% vs KOSPI -10.05% → **격차 2.43%p** |
...
| G. 배치 | 주식 24.8% (tier bull, 목표 [65, 80]) · heat 잔여 217864원 |
...
| `deployment-below-band` | 주식비중 24.8% < 목표 하한 65% — 만성 미배치 | 4주째 | observe — 재확인(07-26): heat 잔여 87,021원/예산 363,020원(24.0%) — 07-19 4,234 |
| `benchmark-gap-widening` | vs KOSPI 격차 악화 14.68%p → 2.43%p | 1주째 | **무처분** |
