...
| C. vs KOSPI (2026-05-20~) | 계좌 -5.595% vs KOSPI -5.83% → **격차 0.24%p** |
...
| G. 배치 | 주식 43.5% (tier bull, 목표 [65, 80]) · heat 잔여 166464원 |
...
| `deployment-below-band` | 주식비중 43.5% < 목표 하한 65% — 만성 미배치 | 9주째 | observe — 18시 sunday_strategy(08-30, 동일 조직 이전 routine)의 재진단을 정책 리뷰 관점에 |
