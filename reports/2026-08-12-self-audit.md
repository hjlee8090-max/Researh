# 2026-08-12 — 주간 자기감사 (self-audit, 기계 생성)
...
| C. vs KOSPI (2026-05-20~) | 계좌 -4.662% vs KOSPI -10.73% → **격차 6.07%p** |
| D. 스톱 휩쏘 | 손실 스톱 7건 중 t+5 채점 7건 · 휩쏘 5건 (71.4%) · 일실 합계 +222,731원 |
| E. 게이트 위반 | 총 0건 (provenance 0 · timing 0 · chase 0 · shock 0 · card 0) |
| F. 패치 vs 검증 | policy v2.31 (직전 감사 v2.31) · 신규 왕복 0건 |
| G. 배치 | 주식 56.5% (tier bull, 목표 [65, 80]) · heat 잔여 143738원 |
...
- `benchmark-gap-widening` vs KOSPI 격차 악화 9.63%p → 6.57%p — 지표 정상화로 자동 해소
