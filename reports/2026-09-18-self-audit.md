...
| C. vs KOSPI (2026-05-20~) | 계좌 -8.579% vs KOSPI -5.0% → **격차 -3.58%p** |
...
| `benchmark-gap-widening` | vs KOSPI 격차 악화 -1.12%p → -3.58%p | 1주째 | **무처분** |
| `lessons-balance` | lessons.md 703,980B > 예산 60,000B — 이관 처리량 부족 | 6주째 🔴overdue | **무처분** (패치 처분 후에도 재발 — 보완 효과 없음, 재상정) |
