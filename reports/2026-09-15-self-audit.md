# 2026-09-15 — 주간 자기감사 (self-audit, 기계 생성)
...
| C. vs KOSPI (2026-05-20~) | 계좌 -7.915% vs KOSPI -7.28% → **격차 -0.63%p** |
...
| G. 배치 | 주식 48.6% (tier bull, 목표 [65, 80]) · heat 잔여 231979원 |
...
| `deployment-below-band` | 주식비중 48.6% < 목표 하한 65% — 만성 미배치 | 11주째 | observe — 재확인(09-13) — 주식비중 37.3%(09-06과 동일) < 목표 하한 65%, heat 잔여 238, |
| `lessons-balance` | lessons.md 637,882B > 예산 60,000B — 이관 처리량 부족 | 5주째 🔴overdue | **무처분** (패치 처분 후에도 재발 — 보완 효과 없음, 재상정) |
