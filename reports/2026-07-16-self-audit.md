# 2026-07-16 — 주간 자기감사 (self-audit, 기계 생성)
...
| C. vs KOSPI (2026-05-20~) | 계좌 -2.01% vs KOSPI -4.83% → **격차 2.82%p** |
| D. 스톱 휩쏘 | 손실 스톱 7건 중 t+5 채점 5건 · 휩쏘 3건 (60.0%) · 일실 합계 +186,797원 |
| E. 게이트 위반 | 총 0건 (provenance 0 · timing 0 · chase 0 · shock 0 · card 0) |
| F. 패치 vs 검증 | policy v2.22 (직전 감사 v2.22) · 신규 왕복 0건 |
| G. 배치 | 주식 37.4% (tier bull, 목표 [65, 80]) · heat 잔여 0원 |
...
| id | 항목 | 경과 | 처분 상태 |
|---|---|---|---|
| `whipsaw-high` | 스톱 휩쏘율 60.0% — 노이즈 저점 매도 반복 | 2주째 🔴overdue | **무처분** |
| `deployment-below-band` | 주식비중 37.4% < 목표 하한 65% — 만성 미배치 | 2주째 🔴overdue | **무처분** |

## ✅ 이번 주 해소 확인 (보완 검증)

- `benchmark-gap-widening` vs KOSPI 격차 악화 -0.86%p → -7.22%p — 지표 정상화로 자동 해소
