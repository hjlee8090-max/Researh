...
| C. vs KOSPI (2026-05-20~) | 계좌 -7.376% vs KOSPI -4.85% → **격차 -2.53%p** |
...
| G. 배치 | 주식 37.3% (tier bull, 목표 [65, 80]) · heat 잔여 238439원 |
...
| `lessons-balance` | lessons.md 608,470B > 예산 60,000B — 이관 처리량 부족 | 5주째 🔴overdue | **무처분** (패치 처분 후에도 재발 — 보완 효과 없음, 재상정) |
