...
| id | 항목 | 경과 | 처분 상태 |
|---|---|---|---|
| `whipsaw-high` | 스톱 휩쏘율 77.8% — 노이즈 저점 매도 반복 | 10주째 | defer — 재확인(09-13) — score_ratchet_shadow.py 재실행 결과 09-06과 수치 불변(bre |
| `deployment-below-band` | 주식비중 37.3% < 목표 하한 65% — 만성 미배치 | 10주째 | observe — 재확인(09-13) — 주식비중 37.3%(09-06과 동일) < 목표 하한 65%, heat 잔여 238, |
| `lessons-balance` | lessons.md 618,559B > 예산 60,000B — 이관 처리량 부족 | 5주째 🔴overdue | **무처분** (패치 처분 후에도 재발 — 보완 효과 없음, 재상정) |
