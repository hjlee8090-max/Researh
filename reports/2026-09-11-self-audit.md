...
| C. vs KOSPI (2026-05-20~) | 계좌 -7.874% vs KOSPI -2.43% → **격차 -5.44%p** |
...
| G. 배치 | 주식 37.0% (tier bull, 목표 [65, 80]) · heat 잔여 287098원 |
...
| `deployment-below-band` | 주식비중 37.0% < 목표 하한 65% — 만성 미배치 | 10주째 | observe — 재확인(09-06) — 08-30 진단(게이트 3종 정당 작동, 국면 의존) 이후 배치가 8.5%로 오히려  |
