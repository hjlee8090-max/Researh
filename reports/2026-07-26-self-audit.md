# 2026-07-26 — 주간 자기감사 (self-audit, 기계 생성)
...
| C. vs KOSPI (2026-05-20~) | 계좌 -4.985% vs KOSPI -4.53% → **격차 -0.46%p** |
...
| G. 배치 | 주식 35.4% (tier bull, 목표 [65, 80]) · heat 잔여 87021원 |
...
| `deployment-below-band` | 주식비중 35.4% < 목표 하한 65% — 만성 미배치 | 3주째 | observe — 히트예산 소진(잔여 4,234원/예산 363,020원)이 만성 미배치의 직접 병목 — 2026-07-04 s |

## ✅ 이번 주 해소 확인 (보완 검증)

- `benchmark-gap-widening` vs KOSPI 격차 악화 2.05%p → -3.28%p — 지표 정상화로 자동 해소
