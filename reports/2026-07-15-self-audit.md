# 2026-07-15 — 주간 자기감사 (self-audit, 기계 생성)
...
| C. vs KOSPI (2026-05-20~) | 계좌 -6.42% vs KOSPI 0.8% → **격차 -7.22%p** |
...
| G. 배치 | 주식 34.5% (tier bull, 목표 [65, 80]) · heat 잔여 153159원 |
...
| `deployment-below-band` | 주식비중 34.5% < 목표 하한 65% — 만성 미배치 | 2주째 🔴overdue | **무처분** |
| `benchmark-gap-widening` | vs KOSPI 격차 악화 -0.86%p → -7.22%p | 1주째 | **무처분** |
