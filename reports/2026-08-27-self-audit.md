# 2026-08-27 — 주간 자기감사 (self-audit, 기계 생성)
...
| C. vs KOSPI (2026-05-20~) | 계좌 -6.844% vs KOSPI -4.1% → **격차 -2.74%p** |
...
| G. 배치 | 주식 56.8% (tier bull, 목표 [65, 80]) · heat 잔여 170913원 |
...
| `deployment-below-band` | 주식비중 56.8% < 목표 하한 65% — 만성 미배치 | 8주째 | observe — 진단 재점검(08-23) — 병목이 이전 두 라운드(히트예산 소진 8/3, universe theme 결측  |
| `benchmark-gap-widening` | vs KOSPI 격차 악화 0.41%p → -2.74%p | 1주째 | **무처분** |
| `lessons-balance` | lessons.md 440,553B > 예산 60,000B — 이관 처리량 부족 | 2주째 | defer — 구조적 원인 확인 — lessons_index.archive_candidates 가 이번에도 0건이다(bui |
