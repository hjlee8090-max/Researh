# 2026-08-17 — 주간 자기감사 (self-audit, 기계 생성)
...
| C. vs KOSPI (2026-05-20~) | 계좌 -3.337% vs KOSPI -3.2% → **격차 -0.14%p** |
...
| G. 배치 | 주식 57.1% (tier bull, 목표 [65, 80]) · heat 잔여 116297원 |
...
| `lessons-balance` | lessons.md 324,346B > 예산 60,000B — 이관 처리량 부족 | 1주째 | **무처분** |
