# 2026-09-01 — 주간 자기감사 (self-audit, 기계 생성)
...
|---|---|
| A. 원장 정합성 | ✅ 일치 |
| B. 계좌 성과 | 왕복 19건 · 승률 31.6% · PF 0.46 · 순실현 -349,404원 |
| C. vs KOSPI (2026-05-20~) | 계좌 -6.135% vs KOSPI -5.83% → **격차 -0.3%p** |
| D. 스톱 휩쏘 | 손실 스톱 9건 중 t+5 채점 9건 · 휩쏘 7건 (77.8%) · 일실 합계 +273,209원 |
| E. 게이트 위반 | 총 0건 (provenance 0 · timing 0 · chase 0 · shock 0 · card 0) |
| F. 패치 vs 검증 | policy v2.36 (직전 감사 v2.36) · 신규 왕복 1건 |
| G. 배치 | 주식 43.2% (tier bull, 목표 [65, 80]) · heat 잔여 191439원 |
...
| `deployment-below-band` | 주식비중 43.2% < 목표 하한 65% — 만성 미배치 | 9주째 | observe — 18시 sunday_strategy(08-30, 동일 조직 이전 routine)의 재진단을 정책 리뷰 관점에 |
| `lessons-balance` | lessons.md 518,978B > 예산 60,000B — 이관 처리량 부족 | 3주째 | defer — 재확인(08-30) — build_lessons_index.py 재실행 결과 archive_candidate |
