...
# 1회 실행하면 평일 00:30/06:30/09:20/12:00/15:00/18:00 + 주말(토 18시 / 일 18·20·21시)에 자동 실행되는 작업이 등록된다.
# 참고: 주 실행 경로는 클라우드 routine(자정은 매일 00:00 발화)이고 이 로컬 스케줄러는 보조 수단이다 (README '실행 방법' 참조).
#
