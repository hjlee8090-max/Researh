# 2026-09-09 — 주간 자기감사 (self-audit, 기계 생성)
...
| C. vs KOSPI (2026-05-20~) | 계좌 -7.66% vs KOSPI -2.36% → **격차 -5.3%p** |
...
| G. 배치 | 주식 29.3% (tier bull, 목표 [65, 80]) · heat 잔여 275258원 |
...
| `deployment-below-band` | 주식비중 29.3% < 목표 하한 65% — 만성 미배치 | 10주째 | observe — 재확인(09-06) — 08-30 진단(게이트 3종 정당 작동, 국면 의존) 이후 배치가 8.5%로 오히려  |
| `lessons-balance` | lessons.md 619,842B > 예산 60,000B — 이관 처리량 부족 | 4주째 🔴overdue | **무처분** (패치 처분 후에도 재발 — 보완 효과 없음, 재상정) |
