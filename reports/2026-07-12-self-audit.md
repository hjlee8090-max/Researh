# 2026-07-12 — 주간 자기감사 (self-audit, 기계 생성)
...
|---|---|
| A. 원장 정합성 | ✅ 일치 |
| B. 계좌 성과 | 왕복 11건 · 승률 27.3% · PF 0.5 · 순실현 -221,934원 |
| C. vs KOSPI (2026-05-20~) | 계좌 -4.084% vs KOSPI 4.37% → **격차 -8.45%p** |
| D. 스톱 휩쏘 | 손실 스톱 7건 중 t+5 채점 4건 · 휩쏘 3건 (75.0%) · 일실 합계 +219,934원 |
| E. 게이트 위반 | 총 0건 (provenance 0 · timing 0 · chase 0 · shock 0 · card 0) |
| F. 패치 vs 검증 | policy v2.22 (직전 감사 v2.22) · 신규 왕복 0건 |
| G. 배치 | 주식 41.6% (tier bull, 목표 [65, 80]) · heat 잔여 34148원 |
...
| id | 항목 | 경과 | 처분 상태 |
|---|---|---|---|
| `whipsaw-high` | 스톱 휩쏘율 75.0% — 노이즈 저점 매도 반복 | 4주째 🔴overdue | **무처분** |
| `deployment-below-band` | 주식비중 41.6% < 목표 하한 65% — 만성 미배치 | 4주째 🔴overdue | **무처분** |
