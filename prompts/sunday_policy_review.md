...
순증 금지 관례 (v2.33 G — report_contract §8 과 동형): **prompts 에 룰·섹션을 추가하는 패치는
은퇴·통합되는 기존 문구를 같은 diff 에서 명시한다.** 대체 없는 순수 추가는 사유를 산출물 1 §3
부작용 점검에 1줄로 남긴다. 준수 여부는 매일 감사의 '프롬프트 순증(7일 전 대비)' INFO 가 추적한다
(절대 상한만으론 재비대를 못 잡는다 — 0900 실측 6/12 감량 후 +37% 재비대).
