...
| C. vs KOSPI (2026-05-20~) | 계좌 -5.12% vs KOSPI -5.56% → **격차 0.44%p** |
...
| G. 배치 | 주식 41.0% (tier bull, 목표 [65, 80]) · heat 잔여 33316원 |
...
| id | 항목 | 경과 | 처분 상태 |
|---|---|---|---|
| `whipsaw-high` | 스톱 휩쏘율 60.0% — 노이즈 저점 매도 반복 | 5주째 🔴overdue | **무처분** |
| `deployment-below-band` | 주식비중 41.0% < 목표 하한 65% — 만성 미배치 | 5주째 🔴overdue | **무처분** |
