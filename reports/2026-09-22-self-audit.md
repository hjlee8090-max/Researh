...
| C. vs KOSPI (2026-05-20~) | 계좌 -7.831% vs KOSPI -1.33% → **격차 -6.5%p** |
...
| `lessons-balance` | lessons.md 742,519B > 예산 60,000B — 이관 처리량 부족 | 6주째 🔴overdue | **무처분** (패치 처분 후에도 재발 — 보완 효과 없음, 재상정) |
