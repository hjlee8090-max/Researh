...
- **폭락 다음날 신규 진입 보류 룰** (2026-06-23 검은 화요일 −9.99% 교훈): 전일 KOSPI 일간 등락률이 **−8% 이하**이면 오늘 신규 진입 기본값=보류 — 반등 1거래일만으로 추격 금지. 재진입 조건: ① 2거래일 연속 종가 안착선 회복, ② 핵심 매크로 이벤트(PCE·CPI·FOMC 등) 통과 or ③ 개별 thesis 강화 공시 확인. 기존 보유 종목 보호손절 실행은 평시와 동일하게 진행한다.
