# 2026-07-28 — 주간 자기감사 (self-audit, 기계 생성)
...
| C. vs KOSPI (2026-05-20~) | 계좌 -6.507% vs KOSPI -13.72% → **격차 7.21%p** |
| D. 스톱 휩쏘 | 손실 스톱 7건 중 t+5 채점 7건 · 휩쏘 5건 (71.4%) · 일실 합계 +222,731원 |
| E. 게이트 위반 | 총 0건 (provenance 0 · timing 0 · chase 0 · shock 0 · card 0) |
| F. 패치 vs 검증 | policy v2.24 (직전 감사 v2.24) · 신규 왕복 1건 |
| G. 배치 | 주식 25.7% (tier bull, 목표 [65, 80]) · heat 잔여 166527원 |
...
| `deployment-below-band` | 주식비중 25.7% < 목표 하한 65% — 만성 미배치 | 4주째 | observe — 재확인(07-26): heat 잔여 87,021원/예산 363,020원(24.0%) — 07-19 4,234 |
