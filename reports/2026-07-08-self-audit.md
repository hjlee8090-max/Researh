# 2026-07-08 — 주간 자기감사 (self-audit, 기계 생성)
...
| C. vs KOSPI (2026-05-20~) | 계좌 -5.995% vs KOSPI 7.4% → **격차 -13.39%p** |
...
| G. 배치 | 주식 53.0% (tier bull, 목표 [65, 80]) · heat 잔여 28106원 |
...
| id | 항목 | 경과 | 처분 상태 |
|---|---|---|---|
| `whipsaw-high` | 스톱 휩쏘율 75.0% — 노이즈 저점 매도 반복 | 2주째 🔴overdue | **무처분** |
| `deployment-below-band` | 주식비중 53.0% < 목표 하한 65% — 만성 미배치 | 2주째 🔴overdue | **무처분** |
