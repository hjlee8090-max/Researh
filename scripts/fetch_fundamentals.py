...
# 당해연도 내 순서는 제출 시기 역순(3분기 11월 → 반기 8월 → 1분기 5월 → 사업 3월)이어야 한다 —
# 과거→최신 순으로 두면 첫 매칭 반환 구조상 반기 제출(8/14) 이후 연말까지 1분기 실적을
# "최신"으로 수집해 earnings_signal·YoY 가 2개 분기 뒤처진다 (2026-07-08 정밀 검사 수정).
REPORT_ORDER = [
    (0, "11014", "3분기"), (0, "11012", "반기"), (0, "11013", "1분기"), (0, "11011", "사업(연간)"),
